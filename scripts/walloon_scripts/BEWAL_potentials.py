        ...
        for carrier in potentials.index:
            ...
            if carrier in n.generators.carrier.unique() and carrier not in [
                ...
                if pypsa_eur_potential <= potential:
                    n.generators.loc[unsustainable_idx, ["p_nom", "e_sum_max"]] = (
                    ...
                    n.generators.loc[f"BEWAL {carrier}", ["p_nom", "e_sum_max"]] = (
                        potential
                    )
                ...
                n.stores.loc[
                    ...
                    ["e_nom_min", "e_nom", "e_nom_max", "e_initial"],
                ] = potential
                ...
                n.generators.loc[sustainable_idx, "e_sum_max"] = potential
