...
def extract_pypsa_demands(annual_values_df,mapping, raw_flows_df, processes_df, commodities_mapping_df, start_year=2021, end_year=2050, apply_netting=True):
    ...
    extraction_rules = {
        ...
        'BEWAL residential rural heat': ('VAR_FOut','combined', [('process_agg', ['Residential rural Coal heater','Residential rural electric heater','Residential rural Heat pump','Residential rural geothermal heating','Residential rural gas heater','Residential rural biomass heater','Residential rural solar thermal','Residential rural oil heater']),('pypsa_carrier', ['Heat'])]),
        ...
        'residential urban decentral gas boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral gas heater']), ('pypsa_carrier', ['Heat'])]),
        'residential urban decentral coal boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral Coal heater']), ('pypsa_carrier', ['Heat'])]),
        'residential urban decentral electric heater': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral electric heater']), ('pypsa_carrier', ['Heat'])]),
        'residential urban decentral heat pump': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral Heat pump']), ('pypsa_carrier', ['Heat'])]),
        'residential urban decentral geothermal': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral geothermal heating']), ('pypsa_carrier', ['Heat'])]),
        'residential district heating': ('VAR_FOut', 'combined', [('process_agg', ['District heating']), ('pypsa_carrier', ['Heat'])]),
        'residential urban decentral biomass boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral biomass heater']), ('pypsa_carrier', ['Heat'])]),
        'residential urban decentral solar thermal': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral solar thermal']), ('pypsa_carrier', ['Heat'])]),
        'residential urban decentral oil boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential urban decentral oil heater']), ('pypsa_carrier', ['Heat'])]),
        #Residential rural
        'residential rural gas boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural gas heater']), ('pypsa_carrier', ['Heat'])]),
        'residential rural coal boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural Coal heater']), ('pypsa_carrier', ['Heat'])]),
        'residential rural electric heater': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural electric heater']), ('pypsa_carrier', ['Heat'])]),
        'residential rural heat pump': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural Heat pump']), ('pypsa_carrier', ['Heat'])]),
        'residential rural geothermal': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural geothermal heating']), ('pypsa_carrier', ['Heat'])]),
        'residential rural biomass boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural biomass heater']), ('pypsa_carrier', ['Heat'])]),
        'residential rural solar thermal': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural solar thermal']), ('pypsa_carrier', ['Heat'])]),
        'residential rural oil boiler': ('VAR_FOut', 'combined', [('process_agg', ['Residential rural oil heater']), ('pypsa_carrier', ['Heat'])]),
        #Commercial
